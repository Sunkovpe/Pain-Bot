/**
 * 🪙 JUEGO DE CARA O SELLO - PAIN BOT
 * Sistema de apuestas con probabilidades variables según el monto
 */
...
function calculateProbability(bet) {
  if (bet <= 200) return 0.5  // 50% para apuestas pequeñas
  if (bet <= 500) return 0.4  // 40% para apuestas medianas
  if (bet <= 1000) return 0.3 // 30% para apuestas grandes
  return 0.2 
}
